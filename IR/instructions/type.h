...
template <> struct TypeIdToType<TypeId::U8> {
  using type = uint8_t;
};
template <> struct TypeIdToType<TypeId::U16> {
  using type = uint16_t;
};
template <> struct TypeIdToType<TypeId::U32> {
  using type = uint32_t;
};
template <> struct TypeIdToType<TypeId::U64> {
  using type = uint64_t;
};
template <> struct TypeIdToType<TypeId::I8> {
  using type = int8_t;
};
template <> struct TypeIdToType<TypeId::I16> {
  using type = int16_t;
};
template <> struct TypeIdToType<TypeId::I32> {
  using type = int32_t;
};
template <> struct TypeIdToType<TypeId::I64> {
  using type = int64_t;
};
template <> struct TypeIdToType<TypeId::F32> {
  using type = float;
};
template <> struct TypeIdToType<TypeId::F64> {
  using type = double;
};
template <> struct TypeIdToType<TypeId::VOID> {
  using type = void;
};
template <> struct TypeIdToType<TypeId::NONE> {
